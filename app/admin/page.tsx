    ...
    >
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <motion.div variants={itemVars} className="lg:col-span-7 bg-[#0a0a0a] rounded-3xl p-6 md:p-10 relative md:overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-1 bg-[#FF6B00] rounded-t-3xl md:rounded-none" />
          ...
          <motion.div variants={itemVars} className="lg:col-span-5 bg-[#0a0a0a] rounded-3xl p-6 md:p-10 relative md:overflow-hidden flex flex-col justify-center">
